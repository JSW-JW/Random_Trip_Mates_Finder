...
class CategoryItem(private val text: String, private val category_id: Int, private val restaurant: Restaurant, val categoryListener: CategoryListener, val context: Context) : Item<GroupieViewHolder>() {
